...
\noindent {\bf SCRUM-Master:} Tina Jensen
...
\begin{comment}
Stikord: Hyppige møder med kunde - forventningsafstemning, kodereview og pair programming

Det skal beskrives, hvordan kvaliteten i projektet sikres i form af opstilling af
kvalitetsmål, metoder til indbygning af kvalitet samt kontrol af resultatets kvalitet. Dette
gøres ud fra den valgte metode.
\end{comment}
...
\begin{comment}
Stikord: scrum, samarbejde med kunden
Her beskrives gruppens vurdering af projektets forløb generelt, og specielt skal gruppen forholde sig til den valgte metode. Der lægges i dette afsnit vægt på refleksion over gruppens oplevelser med den valgte metode frem for beskrivelse af forløbet. Beskriv jeres erfaringer med anvendelsen af den valgte metode, beskriv metodens oplevede stærke og svage sider.
Vurdering af gruppesamarbejdet og rollefordelingen.
Uanset valget af metode bør der evalueres på produkt og proces i bred forstand samt eventuelt samarbejde med interessenter. Vurder om valget af en agil metode giver et anderledes produkt end hvis valget havde været UP eller omvendt, vurder produktet udfra et teknisk perspektiv og ud fra et brugs perspektiv.
\end{comment}

\chapter{Produktet}
\section{Kravspecifikation}
%Indsæt billede af backlog.. kravspec is aaaaall our user stories
...
\label{model}
\end{figure}
%indsæt kommentar til klasserne
