    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        foreach (var t in query)
        {
            ...
            if(((string)Session["lang"]) == "da")
            {
                ...
                Text = string.Format("<tr><td class=\"housephoto\"><img src=\"http://ungdomsboligaarhus.dk/web/512/ktp.nsf/Pics/AFD53532.JPG/$File/AFD53532.JPG?OpenElement\" height=\"180\" width=\"220\" /></td>" +
                    "<td class=\"boliginfo\"><span class=\"bold\">Pris pr. måned:</span><br />{1} kr<br /><br /><span class=\"bold\">A/C udgifter:</span><br />{8} kr<br /><br /><span class=\"bold\">Samlet:</span><br />{9} kr<br /><br /><span class=\"bold\">Depositum:</span><br/>{2} kr<br/><br/><span class=\"bold\">Ventetid:</span><br/>{3}<br/><br/></td>" +
                    "<td class=\"boligcontent\">{7}{4}<br /><br /><span class=\"bold\">Afdeling:</span><br />{6}. {0}<br /><br /><span class=\"bold\">Værelser:</span> {10} <span class=\"bold\">Personer:</span> {11} <span class=\"bold\">Børn:</span> {12}<br /><br /><span class=\"bold\">Kat tilladt:</span> {13} <span class=\"bold\">Hund tilladt:</span> {14} <span class=\"bold\">Små kæledyr tilladt:</span> {15}<br /><br /><span class=\"bold\">Eget bad:</span> {16} <span class=\"bold\">Eget Køkken:</span> {17}</td>" +
                    "<td class=\"area\">Område:<br/>{5}</td></tr>", t.department1.description_dk, t.monthly_price, t.deposit, 300, t.description_dk, t.area, t.department1.name, links, t.ac_expenses, t.ac_expenses + t.monthly_price, t.rooms, t.persons, t.children, t.cat_amount, t.dog_amount, t.small_pets_amount, t.bath, t.kitchen)
                });
            }
            else 
            {
                BoligContent.Controls.Add(new Literal()
                {
                    ...
                    "<td class=\"boliginfo\"><span class=\"bold\">Monthly rent:</span><br />{1} kr<br /><br /><span class=\"bold\">A/C expenses:</span><br />{8} kr<br /><br /><span class=\"bold\">Total:</span><br />{9} kr<br /><br /><span class=\"bold\">Deposit:</span><br/>{2} kr<br/><br/><span class=\"bold\">Wait time:</span><br/>{3}<br/><br/></td>" +
                    "<td class=\"boligcontent\">{7}{4}<br /><br /><span class=\"bold\">Department:</span><br />{6} {0}<br /><br /><span class=\"bold\">Rooms:</span> {10} <span class=\"bold\">Persons:</span> {11} <span class=\"bold\">Children:</span> {12}<br /><br /><span class=\"bold\">Cats allowed:</span> {13} <span class=\"bold\">Dogs allowed:</span> {14} <span class=\"bold\">Small pets allowed:</span> {15}<br /><br /><span class=\"bold\">Own bath:</span> {16} <span class=\"bold\">Own kitchen:</span> {17}</td>" +
                    "<td class=\"area\">Area:<br/>{5}</td></tr>", t.department1.description_en, t.monthly_price, t.deposit, 300, t.description_en, t.area, t.department1.name, links, t.ac_expenses, t.ac_expenses + t.monthly_price, t.rooms, t.persons, t.children, t.cat_amount, t.dog_amount, t.small_pets_amount, t.bath, t.kitchen)
                });
            }           
        }
    }
