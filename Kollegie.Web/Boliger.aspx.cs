...
public partial class Boliger : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            string dep_description = ((string)Session["lang"]) == "da" ? t.department1.description_dk : t.department1.description_en;
            string description = (string)Session["lang"] == "da" ? t.description_dk : t.description_en;
            ...
            {                
                Text = string.Format("<tr><td valign=\"top\" class=\"housephoto\"><img src=\"http://ungdomsboligaarhus.dk/web/512/ktp.nsf/Pics/AFD53532.JPG/$File/AFD53532.JPG?OpenElement\" height=\"180\" width=\"220\" /></td>" +
                    ...
                    "<td valign=\"top\"><a href=\"rosbolig.aspx?rediger={7}\">Rediger</a> &nbsp;<a href=\"rosbolig.aspx?slet={7}\">Slet</a><br /><br />{4}<br /><br /><span class=\"bold\">Afdeling:</span><br />{6}</td><td valign=\"top\">Område:<br/>{5}</td></tr>", dep_description, t.monthly_price, t.deposit, 300, description, t.area, t.department1.name, t.id, t.ac_expenses, t.ac_expenses + t.monthly_price)
            });
        }
    }
}
