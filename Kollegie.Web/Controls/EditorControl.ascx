...
<div class="overskrift_container">
    <img onclick="BoldText();" src="img/fed.png" class="format_button" alt="Bold" id="Button_Bold" /> 
    <img onclick="ItalicText();" src="img/kursiv.png" class="format_button" alt="Italic" id="Button_Italic" /> 
    <img onclick="UnderlineText();" src="img/underline.png" class="format_button" alt="Underline" id="Button_Underline" />
